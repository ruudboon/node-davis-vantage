...
function _isBitSet(num, bit){
    return ((num>>bit) % 2 != 0);
}

function _parseIconValue(value){
    var iconObject = {};
    iconObject.rain = _isBitSet(value, 0);
    iconObject.cloudy = _isBitSet(value, 1);
    iconObject.partly_cloudy = _isBitSet(value, 2);
    iconObject.sun = _isBitSet(value, 3);
    iconObject.snow = _isBitSet(value, 4);
   
    return iconObject;
}

function _convertTime(value){
